...
const Header = ({ activeHeading }) => {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
          ...
          <div className="flex justify-end">
            <Link to={isSeller ? "/dashboard" : "/shop-create"}>
              <div className="bg-pink-500 text-white px-5 py-2 rounded-full hover:bg-pink-600 transition font-semibold text-sm">
      ...
      {/* Second Row */}
      <section className="w-full bg-white border-t border-gray-200 shadow-sm mt-[90px]">
        <div className="max-w-7xl mx-auto px-4 py-2 grid grid-cols-3 items-center">
          ...
          <div className="flex justify-start">
            ...
            {dropDownVisible && (
              <div className="absolute top-full mt-2 z-50 bg-white shadow-md rounded-md border p-4">
                <DropDown
